...
const Footer = () => {
  return (
    <>
    <footer class="footer p-20 bg-base-200 text-base-content">
      <div>
    ...
    <footer class="footer px-20 py-4 border-t bg-base-200 text-base-content border-base-300">
      <div class="items-center grid-flow-col">
        ...
        <p>Photography Tools <br/>Developed by @ mdshohed</p>
      </div> 
